...
// import { Upload, Library, FileText, Settings } from 'lucide-react';
...
//         <h1 className="text-xl font-bold text-gray-800">Connecting Dots</h1>
//         <p className="text-sm text-gray-600">Made by UV BOYS</p>
//       </div>

//       <div className="p-4">
//         <button
//           onClick={() => setShowUpload(true)}
//           className="w-full bg-blue-600 text-white px-4 py-3 rounded-lg flex items-center gap-2 hover:bg-blue-700 transition-colors"
//         >
//           <Upload size={20} />
//           Upload PDFs
//         </button>
...
//     >
//       <rect y="4" width="22" height="2.5" rx="1.2" fill="#374151" />
//       <rect y="9.5" width="22" height="2.5" rx="1.2" fill="#374151" />
//       <rect y="15" width="22" height="2.5" rx="1.2" fill="#374151" />
//     </svg>
//   );

//   return (
//     <div
//       className={`relative h-screen shadow-lg flex flex-col bg-white 
...
//           className="m-3 rounded-md bg-gray-100 p-2 hover:bg-gray-200 transition-colors duration-300"
//           tabIndex={0}
//           aria-label="Toggle sidebar"
//         >
...
//               : 'opacity-100 max-w-full p-3 m-0'}
//           `}
//         >
//           {/* <h1 className="text-xl font-bold text-gray-800 whitespace-nowrap">Connecting Dots</h1>
//           <p className="text-sm text-gray-600 whitespace-nowrap">Made by UV BOYS</p> */}
...
//       <div
//         className={`p-4 transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)]
//           ${collapsed ? 'px-2' : 'px-4'}`}
//       >
//         <button
//           onClick={() => setShowUpload(true)}
//           className={`w-full bg-blue-600 text-white rounded-lg flex items-center gap-2 py-3 hover:bg-blue-700 
...
//             key={item.id}
//             onClick={() => setCurrentView(item.id)}
//             className={`w-full flex items-center rounded-lg mb-2 transition-colors duration-300
//               ${currentView === item.id
//                 ? 'bg-blue-50 text-blue-600 border-l-4 border-blue-600'
//                 : 'text-gray-600 hover:bg-gray-50'
//               }
...
//       {/* Sidebar Content */}
//       <div className="flex items-center border-b bg-white/80 backdrop-blur-sm relative z-10">
//         <button
//           onClick={() => setCollapsed(!collapsed)}
//           className="m-3 rounded-md bg-gray-100 p-2 hover:bg-gray-200 transition-colors duration-300"
//           tabIndex={0}
...
//             key={item.id}
//             onClick={() => setCurrentView(item.id)}
//             className={`w-full flex items-center rounded-lg mb-2 transition-colors duration-300 group
//               ${currentView === item.id
//                 ? 'bg-blue-50 text-blue-600 border-l-4 border-blue-600'
//                 : 'text-gray-600 hover:bg-gray-50'}
//               ${collapsed ? 'justify-center gap-0 px-0 py-3' : 'gap-3 px-3 py-3'}`}
