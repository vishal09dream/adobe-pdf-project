...
// import { FileText, Clock, CheckCircle, RefreshCw, Eye } from 'lucide-react';

// const Library = ({ library, selectedFiles, setSelectedFiles, onRefresh, onViewFile }) => {
...
//     // If file is not already selected, add it to selection
//     if (!selectedFiles.find(f => f.id === file.id)) {
//       setSelectedFiles(prev => [...prev, file]);
//     }
    
//     // Put this file first in the selection for viewing
//     setSelectedFiles(prev => [
//       file,
//       ...prev.filter(f => f.id !== file.id)
//     ]);
...
//           disabled={loading}
//           className="px-4 py-2 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200 transition-colors flex items-center gap-2 disabled:opacity-50"
//         >
...
//               <h3 className="font-medium text-gray-800 mb-2 truncate" title={file.name}>
//                 {file.name}
//               </h3>
...
//         <div className="fixed bottom-6 right-6 bg-white shadow-lg rounded-lg p-4 border z-10">
...
// import React from 'react';
// import { FileText, Clock, CheckCircle, RefreshCw, Eye, CheckSquare, Trash2 } from 'lucide-react';
...
//     if (!confirm(`Are you sure you want to delete ${selectedFiles.length} document(s)?`)) {
//       return;
//     }
...
//             title={selectedFiles.length === 0 ? "Select files to delete" : "Delete selected PDFs"}
//           >
...
//           >
//             <CheckSquare size={16} />
//             {selectedFiles.length === library.length ? "Deselect All" : "Select All"}
//           </button>
//           <button
//             onClick={handleRefresh}
//             disabled={loading}
...
//               onClick={() => toggleFileSelection(file)}
//               className={`p-4 border rounded-lg cursor-pointer transition-all ${
//                 isSelected(file) ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'
//               }`}
//             >
//               <div className="flex items-start justify-between mb-3">
//                 <FileText size={24} className="text-blue-600" />
//                 <div className="flex items-center gap-2">
//                   {isSelected(file) && <CheckCircle size={20} className="text-blue-600" />}
//                   <button
//                     onClick={(e) => handleViewFile(e, file)}
//                     className="p-1 text-gray-400 hover:text-blue-600 transition-colors"
//                     title="View PDF"
